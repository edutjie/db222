INSERT INTO sirest.food (rname, rbranch, foodname, description, stock, price, fcategory)
VALUES  ('Feedburner Eats', 'Bubutan', 'Risotto', 'Fluffy and warm risotto', 7, 20000, 'FC3'),
        ...
        ('ABX', 'Brontokusuman', 'Nasi Goreng ABX', 'Fried Rice with ABX special sauce', 6, 60000, 'FC1'),
        ('KFC', 'Margonda', 'Ayam Goreng', 'Ayam KFC', 100, 30000, 'FC3'),
        ('KFC', 'Lenteng Agung', 'Ayam Goreng', 'Ayam KFC', 100, 30000, 'FC3'),
        ('KFC', 'Margonda', 'Burger Ayam', 'Burger KFC', 100, 20000, 'FC3');